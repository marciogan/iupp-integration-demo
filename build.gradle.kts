...
application {
    mainClass.set("br.com.iupp.ApplicationKt")
}
...
dependencies {
    ...
    implementation(Dependencies.LogDependencies.SLF4J)
    implementation(Dependencies.LogDependencies.LAYOUT)
...
kapt {
    arguments {
        ...
        arg("micronaut.processing.annotations", "${Dependencies.Iupp.GROUP}.*")
        arg("micronaut.processing.group", Dependencies.Iupp.GROUP)
